document.addEventListener("DOMContentLoaded", () => {
  ...
  function showquestions(){
    const quizquestion = currentquestions[currentquestionindex];
     ...
     quizquestion.options.forEach(option=>{
      ...
      optionelement.addEventListener('click',()=>{
       if(!answerselected){
          ...
          checkanswer(option,quizquestion.answer);
      ...
      inputElement.type = quizquestion.questionType === 'number'?'number':'text';

      const submitbutton = document.createElement("button");
      submitbutton.textContent = 'Submit Answer';
      submitbutton.classList.add('submitAns')

      submitbutton.onclick=()=>{
          if(!answerselected){
              answerselected = true;
              checkanswer(inputElement.value.toString(),quizquestion.answer.toString());
          }
      };
